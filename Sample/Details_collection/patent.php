...
?>
    ...
    ?>
        ...
        <h2 class="text-center" style="margin-top:1%; margin-bottom: 2% ">Patent</h2>
                ...
                <div class="col-lg-8">
                    <div class="card" style="width:100%; border:1px solid blue; border-radius:10px">
                        ...
                        <form action="chapter.php" method="POST">
                            ...
                            <input type="text" id="chapter" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="Enter Faculty Designation here" name="designation" required>
                            <label class="col-lg-4"><span>*</span> Patent :</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="Enter Patent here" name="patent" required>
                            <label class="col-lg-4"><span>*</span> Title :</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" placeholder="Enter Title here" value=" " name="title" required>
                            ...
                            <textarea class= "form-control col-lg-8 m-b-10 " rows="3" autocomplete="off" value=" " placeholder="Enter option 1 here.." name="opt1"></textarea>
                            <label class="col-lg-4">  Option 2 :</label>
                            <textarea class= "form-control col-lg-8 m-b-10 " rows="3" autocomplete="off" value=" " placeholder="Enter option 2 here.." name="opt2"></textarea>
                            ...
                            <button type="submit" class="btn btn-primary col-lg-4 btn-lg m-t-10" style="float: right ;clear:both" name="submit_patrnt">Submit</button>
                        </div>  
                    </form>
        ...
        <div class="card" style="width:100%; border:1px solid blue; border-radius:10px">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg btn-block" name="show_patent" >Show Patent Records</button> 
