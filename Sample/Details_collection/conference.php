...
?>
    ...
    ?>
        ...
        <h2 class="text-center" style="margin-top:1%; margin-bottom: 2% ">Conferences</h2>
                ...
                <div class="col-lg-8">
                    <div class="card" style="width:100%; border:1px solid blue; border-radius:10px">
                        ...
                        <form action="chapter.php" method="POST">
                            ...
                            <input type="text" id="chapter" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="Enter Title of paper here" name="paper_title" required>
                            <label class="col-lg-4"><span>*</span> Name of Conference:</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="Enter Conference Name here" name="con_name" required>
                            <label class="col-lg-4"><span>*</span> Conference Place:</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="Enter Conference Place here" name="con_place" required>
                            <label class="col-lg-4"><span>*</span> Conference Date :</label>
                            <input type="date" class="form-control col-lg-8 m-b-10" value=" " name="con_date" required>
                            <label class="col-lg-4"><span>*</span> Ntnl/Intnl :</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" value=" " placeholder="Enter Ntnl/Intnl here" name="ntnl_no" required>
                            <label class="col-lg-4"><span>*</span> ISBN/ISBN/ACCN Number :</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="Enter ISBN/ISSN/ACCN number here" name="isbn_no" required>
                            <label class="col-lg-4"><span>*</span> DOI :</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="Enter DOI here" name="doi" required>
                            ...
                            <input type="text" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="Indexed in IEEE Explorer/ Scopus/..." name="indexed_in" required>
                            ...
                            <label class="col-lg-4"><span>*</span> Presented Personally :</label>
                            ...
                            <textarea class= "form-control col-lg-8 m-b-10 " rows="3" autocomplete="off" value=" " placeholder="Enter option 3 here.." name="opt3"></textarea>
                            <button type="submit" class="btn btn-primary col-lg-4 btn-lg m-t-10" style="float: right ;clear:both" name="submit_conference">Submit</button>
                            </div>  
                    </form>
...
<br>
        ...
        <div class="card" style="width:100%; border:1px solid blue; border-radius:10px">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg btn-block" name="show_conference" >Show Conferences Records</button> 
