...
?>
    ...
    ?>
        ...
        <h2 class="text-center" style="margin-top:1%; margin-bottom: 2% ">Book Chapter</h2>
                ...
                <div class="col-lg-8">
                    <div class="card" style="width:100%; border:1px solid blue;  border-radius:10px">
                        ...
                        <form action="chapter.php" method="POST">
                            ...
                            <input type="text" class="form-control col-lg-8 m-b-10" placeholder="Enter SDRN here" autocomplete="off"  value=" "  name="sdrn" required>   
                            <label class="col-lg-4"><span>*</span> Faculty Name :</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" placeholder="Enter Faculty Name here" autocomplete="off" value=" " name="faculty_name" required>
                            ...
                            <label class="col-lg-4"><span>*</span> Chapter Name :</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" value=" " placeholder="Enter Chapter Name here" autocomplete="off" name="chapter_name" required>
                            ...
                            <label class="col-lg-4"><span>*</span> Through Conference/Journal :</label>
                            <input type="text" class="form-control col-lg-8 m-b-10" value=" " placeholder="Through Conference/Journal" autocomplete="off" name="through" required>
                            ...
                            <input type="date" class="form-control col-lg-8 m-b-10" name="publication_year" value="" placeholder="0000/00/00" required>
                            ...
                            <button type="submit" class="btn btn-primary col-lg-4 btn-lg m-t-10" style="float: right ;clear:both" name="submit_chapter">Submit</button>
                        </div>  
                    </form>
        ...
        <div class="card" style="width:100%; border:1px solid blue; border-radius:10px">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg btn-block" name="show_book_chapter" >Show Book Chapter Records</button> 
