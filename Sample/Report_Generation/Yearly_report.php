...
<div  style="margin: 5%">
  <h3><b><center>Yearly Report</center></b></h3><br>
  ...
  <label style="margin-right:10px">Select Year: </label>
    ...
    <input type="submit" value="Submit" name="yearly_data">
  </form>
  ...
  <?php
    ...
    //////////////////////////////////////////////////////Book Chapter////////////////////////////////////////////////////
      ...
      function yearly_chapterData(){
        ...
        echo "<b><center><p> Records from $from to $to of year $year1 are :</p> </center> </b>";
        echo "<p> Book Chapter Records :</p>";
        $output = "";
        $conn = mysqli_connect("localhost", "root", "", "test");
        $sql =   "SELECT * from book_chapter where YEAR(publication_year) = '$year1' and publication_year between '$from' and '$to'";
    ...
    //////////////////////////////////////////////////////Book Publications////////////////////////////////////////////////////
      echo'<div class="table-responsive">
        ...
        function yearly_PublicationData(){
          ...
          $conn = mysqli_connect("localhost", "root", "", "test");
          $sql =   "SELECT * from book_publication where YEAR(year) = '$year1' and year between '$from' and '$to'";
          $result = mysqli_query($conn, $sql);
          while($row = mysqli_fetch_array($result)){
            $output .= '<tr>
              <td>'.$row["sdrn"].'</td>
...
////////////////////////////////////////////////////// Patent ////////////////////////////////////////////////////////////////
      echo'<div class="table-responsive">
        ...
        function yearly_PatentData(){
          ...
          $output = "";
          $conn = mysqli_connect("localhost", "root", "", "test");
          $sql =   "SELECT * from patent where YEAR(reg_date) = '$year1' and reg_date between '$from' and '$to'";
...
////////////////////////////////////////////////////// Copyright ////////////////////////////////////////////////////////////////
    ...
    function yearly_CopyrightData(){
      ...
      $output = "";
      $conn = mysqli_connect("localhost", "root", "", "test");
      $sql =   "SELECT * from copyright where YEAR(reg_date) = '$year1' and reg_date between '$from' and '$to'";
        $result = mysqli_query($conn, $sql);
        while($row = mysqli_fetch_array($result)){
          $output .= '<tr>
            <td>'.$row["sdrn"].'</td>
...
////////////////////////////////////////////////////// Journal ////////////////////////////////////////////////////////////////
    ...
    function yearly_JournalData(){
      ...
      $output = "";
      $conn = mysqli_connect("localhost", "root", "", "test");
      $sql =   "SELECT * from journal where YEAR(year) = '$year1' and year between '$from' and '$to'";
        $result = mysqli_query($conn, $sql);
        while($row = mysqli_fetch_array($result)){
          $output .= '<tr>
            <td>'.$row["sdrn"].'</td>
...
////////////////////////////////////////////////////// Conferences ////////////////////////////////////////////////////////////////
    ...
    function yearly_ConferenceData(){
      ...
      $output = "";
      $conn = mysqli_connect("localhost", "root", "", "test");
      $sql =   "SELECT * from conference where YEAR(year) = '$year1' and year between '$from' and '$to'";
        $result = mysqli_query($conn, $sql);
        while($row = mysqli_fetch_array($result)){
          $output .= '<tr>
            <td>'.$row["sdrn"].'</td>
